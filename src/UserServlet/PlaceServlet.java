...
//	    System.out.println(GymArea);
		String SonPlace=(String) result.get("SonPlace");
//		 System.out.println(SonPlace);
		...
		try{	String sql=null;
		    sql="select distinct Place from Area where GymArea=? and SonPlace=? and Status='可用'";
		    conn=ConnectionFactory.getConnection();
			 pstmt=conn.prepareStatement(sql);
			// pstmt.setString(1, tel);
			 pstmt.setString(1, GymArea);
			 pstmt.setString(2, SonPlace);
